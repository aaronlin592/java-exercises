...
public abstract class MerchandiseItem {
	...
	public String toString() {
		return "id: " + getID() + ", name: " + getName() + ", price: " + getPrice(); // FIX ME
	}
	
	@Override
	public boolean equals(Object otherObject) {
		MerchandiseItem other = (MerchandiseItem) otherObject;
		return this.getName().equals(other.getName()) && this.getPrice() == other.getPrice() && this == other;
	}
